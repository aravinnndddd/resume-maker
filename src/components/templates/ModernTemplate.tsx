      ...
      <div className="flex">
        ...
        <div className="w-1/3 bg-gradient-to-b from-blue-600 to-blue-800 text-white p-8">
          ...
          {data.skills.length > 0 && (
            <div className="mb-8">
              <h2 className="text-lg font-bold mb-4 border-b border-blue-400 pb-2">
                SKILLS
              </h2>
            ...
            <div>
              ...
              {data.education.map((edu) => (
                <div key={edu.id} className="mb-4 text-sm">
                  ...
                  {edu.gpa && (
                    <p className="text-blue-100 text-xs">GPA: {edu.gpa}</p>
                  )}
                </div>
              ))}
            </div>
          ...
          {data.experiences.length > 0 && (
            <div className="mb-8">
              ...
              {data.experiences.map((exp) => (
                <div
                  key={exp.id}
                  className="mb-6 relative pl-4 border-l-2 border-blue-200"
                >
